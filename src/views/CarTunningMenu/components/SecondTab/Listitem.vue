<template>
  <div class="list-item">
    <div
      ...
      @click="setTab('ThirdTab', item.key)"
      @mouseenter="play({ name: 'hover' , volume: .4 })"
    >
      <img :src="`/img/carTunningMenu/secondTab/${parent}/${item.key}.png`" class="inner">
...
export default {
  ...
  methods: {
    ...
    setTab: function(value, key) {
      ...
      window.mp.trigger('lsCustom:openListTun', key);
      // SOME EVENT (SET THIRD TAB DATA)
    }
  }
}
</script>
