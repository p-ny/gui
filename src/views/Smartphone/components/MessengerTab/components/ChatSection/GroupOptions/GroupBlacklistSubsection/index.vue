<template>
  <div class="canal-blacklist">
    <div class="canal-blacklist__header">
      ...
      <span class="title">{{loc('phone:chat:blist:1')}}</span>
    </div>
    <button class="canal-blacklist__btn-add" @click="isAddUser = true">{{loc('phone:chat:blist:2')}}</button>
    <p class="canal-blacklist__desc">{{loc('phone:chat:blist:3')}}</p>
    <div class="canal-blacklist__main">
      <span class="title">{{loc('phone:chat:blist:4')}}</span>
      <div v-bar>
        <div class="list">
          <!-- <list-item
            v-for="item in users"
