<template>
  <div class="profile-tab">
    <div class="profile-tab__header">
      ...
      <span class="title">{{loc('phone:profile:2')}}</span>
    </div>
    ...
    <div class="profile-tab__abilities">
      <span class="title">{{loc('phone:profile:3')}}</span>
      <div class="list">
        <abilities-item
    ...
    <!-- <button class="profile-tab__btn profile-tab__btn-add">Make admin</button> -->
    <button class="profile-tab__btn profile-tab__btn-remove" @click="isPopup = true">{{loc('phone:profile:4')}}</button>
    ...
    <transition name="smartphone-scale-in">
      <div class="profile-tab__popup" v-if="isPopup">
        <span class="title">{{loc('phone:profile:5')}}</span>
        <p class="desc">{{loc('phone:profile:6')}}</p>
        <button class="btn-confirm" @click="removeAdmin">{{loc('phone:profile:7')}}</button>
...
export default {
  ...
  data: function() {
    return {
      isPopup: false,
      abilityTitles: {
        1: 'phone:profile:abil:1',
        5: 'phone:profile:abil:5',
        2: 'phone:profile:abil:2',
        3: 'phone:profile:abil:3',
        4: 'phone:profile:abil:4'
      }
    }
  },
  ...
  computed: {
    ...
    permissions: function() {
      const channelPermissions = [1,2,3,5,4];
