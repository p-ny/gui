<template>
  <div class="home-subsection">
    <div class="home-subsection__header">
      ...
      <div class="title">{{loc('phone:bank:13')}}</div>
    </div>
    <div class="home-subsection__main">
      <div class="card">
        <img
      ...
      <div class="balance">
        <span class="balance__title">{{loc('phone:bank:14')}}</span>
        <div class="balance__state">
          <span class="current">{{ homeBalance.toLocaleString('en') }}$</span>
...
export default {
  ...
  computed: {
    ...
    ...mapState('smartphone/bankPage', ['balance', 'homeBalance', 'maxHomeBalance']),
    ...
    rightSum: function() {
      return this.maxBalance > this.homeBalance ? this.maxBalance - this.homeBalance : 0
    },
    maxBalance: function() {
  ...
  methods: {
    ...
    toUp: function() {
      ...
      window.mp.triggerServer('phone::bank::payHouseTax', this.localSumModel);      
    }
  }
}
</script>
